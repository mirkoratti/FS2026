...
% --------------------------------------- COLOR DEFINITIONS ---------------------------------------
\definecolor{sectioncolor}{HTML}{BB69C9}
\definecolor{subsectioncolor}{HTML}{E2C0E8}
\definecolor{sectextcol}{HTML}{F2F2F2}
...
\tikzset{
    ...
    % Inheritance arrow UML 
    inheritance/.style={
        -{Triangle[open, angle=60:5pt]}, 
        shorten >=1pt,
        shorten <=1pt,
        draw=black
    },
...
% Makefile style per listings
\lstdefinestyle{makefilestyle}{
    language=makefile,
    % === Parole chiave aggiuntive (Target comuni e variabili automatiche) ===
    morekeywords={clean, all, install, distclean},
    keywordstyle={[2]\color{keywordcolour!80!black}}, % Stile per variabili automatiche
    morekeywords={[2]\$@, \$<, \$\^, \$\?},
%   === Gestione speciale per i Tab (Fondamentali nei Makefile) ===
    showtabs=true,              % Opzionale: mostra i tab per debuggare la sintassi
    % Definisce un simbolo per il tab (es: una freccetta grigia)
    tab=\color{gray!40}\makebox[0pt][l]{\tiny$\rightarrow$}\rule{0pt}{0pt},
    tabsize=4,                   % Dimensione visiva del tab
}
