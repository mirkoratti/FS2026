...
\begin{lstlisting}
<nome_file>:<linea>: <scope>::<nome_funzione>(<tipi_parametri>): Assertion '<condizione_logica>' failed.

// Esempio concreto (es. Classe Torus): // 

torus.cpp:12: Torus::Torus(double, double): Assertion 'smallR > 0.0 && smallR < bigR' failed.
\end{lstlisting}
...
\begin{itemize}
    ...
    \textit{initializer list}, il compilatore invocherà automaticamente il 
