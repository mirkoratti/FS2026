...
\begin{document}
    \begin{layout}
        \input{sections/01_variables.tex}
        \input{sections/02_conditions.tex}
        \input{sections/03_iterations.tex}
        \input{sections/04_built_in_methods.tex}
        \input{sections/05_advanced_unpacking.tex}
        \input{sections/06_object_oriented.tex}
        \input{sections/07_inheritance.tex}
        \input{sections/08_Numpy.tex}
        \input{sections/09_matplotlib.tex}
        \newpage
