...
\setlength{\columnsep}{3mm}       % distance between columns
\setlength{\columnseprule}{0.2pt}   % thickness of column separation line
...
% --------------------------------------- COLOR DEFINITIONS ---------------------------------------
\definecolor{sectioncolor}{HTML}{FF3E96}
\definecolor{subsectioncolor}{HTML}{FF82AB}
                ...
                }
                {
                    ...
                    \begin{minipage}[t]{0.2\columnwidth} % MathFML-like formatting
                        ...
                        \qrcode[level=L, 
                                version=0,
                                height=0.9\columnwidth]{\repo}\hfill
                        \raisebox{0.05\columnwidth}{% Regola questo valore per l'altezza desiderata
