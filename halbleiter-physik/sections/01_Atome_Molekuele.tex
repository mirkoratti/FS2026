...
\cor{Gli elettroni di valenza sono quelli nell'Hauptquanenzahl più alto (ad es. intero blocco $L$)}
...
\subsubsection{Grund-Prinzip von Bindungen zwischen Atomen}\label{chap:bindungstypen}
...
\subsubsection{Kovalente Bindung}
	...
	Il grafico soprastante può essere derivato tramite: $F(r) = \frac{\diff U}{\diff r}$ dove $U$ è l'energia potenziale in \ref{chap:bindungstypen}
...
\subsubsection{Ionische Bindungen: Salze}
	...
	Wo $E_{\text{ion}}$ è l'energia per 'cedere' l'elettrone 
