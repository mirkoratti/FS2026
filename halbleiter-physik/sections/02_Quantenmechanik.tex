...
\subsection{Photoelektrischer Effekt}\vspace{-0.5em}
	\includegraphics[width=0.99\columnwidth]{Bilder/Photoeffekt_2}\vspace{-0.5em}
	...
	Il fatto che $V_0$ sia identico per diverse intensità dimostra che la luce è quantizzata in fotoni ($E=hf$). 
	Secondo la fisica classica (luce come onda continua), un'intensità maggiore ($I_2$) dovrebbe trasferire più energia continua agli elettroni, richiedendo una tensione di arresto $V_0$ più grande 
...
\begin{tabular}{lll}
    Energie des Elektrons & $\displaystyle E_{e} = \frac{1}{2} m v^{2}$ & \\ 
						& $\displaystyle E_e = E_\gamma - \phi$ & wo $\phi$ Austrittsarbeit ist\\
    Energie des Photons & $\displaystyle E_{\gamma} = h \cdot \frac{c}{\lambda} = h \cdot f$ & $\left(f = \dfrac{c}{\lambda}\right)$\\ 
	...
	Numero di elettroni & $\displaystyle N_e = \frac{P\cdot t}{E_\gamma}$&
\end{tabular}
