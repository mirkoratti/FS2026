...
\subsection{Bänder-Modell im Impulsraum}
	...
	Da im Metall an der Fermi-Kante die
Zustandsdichte > 0 ist, führt ein kleines elektrisches Feld bereits zu einem Stromfluss
(Elektronen ”rutschen”nach unten)
...
\begin{tabular}{p{0.49\linewidth}p{0.5\linewidth}}
	$P (E) = A \cdot e^{-\frac{E}{k_BT}}$ & P (E) = $\dfrac{1}{1+A \cdot e^{\frac{E-E_F}{k_BT}}}$
\end{tabular}
...
\begin{itemize}
	...
	\item[$\Rightarrow$] Kontaktspannung kann \textbf{keine} Arbeit verrichten (2. Hauptsatz thermodinamik)
\end{itemize}
