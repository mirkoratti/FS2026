...
Muss man das p-dotierte halbleiter stärker dotieren da man die Verarmungsschicht v.a. im n-dotierten Halbleiter haben möchte!
	\begin{center}
		\includegraphics[width=0.8\linewidth]{Bilder/JFET_1}
	\end{center}

	\begin{minipage}{0.5\linewidth}
		\includegraphics[width=0.8\linewidth]{Bilder/JFET_4}
