...
\usepackage{pgfplots}               % needed to draw graphs of functions
\pgfplotsset{compat=1.18} % Usa la versione che hai installata
...
% --------------------------------------- COLOR DEFINITIONS ---------------------------------------
\definecolor{sectioncolor}{HTML}{44ed66}
\definecolor{subsectioncolor}{HTML}{b4f8c2}
...
\pgfplotsset{
    tiny_trig_plot/.style={
        width=\linewidth,       % Impone al grafico di occupare tutta la minipage
        axis lines=middle,      % Assi cartesiani al centro
        xmin=-3.5, xmax=3.5,    % Limiti asse X (leggermente più di -pi e pi)
        ymin=-1.2, ymax=1.2,    % Limiti asse Y
        xtick={-3.1415, 0, 3.1415}, 
        xticklabels={$-\pi$, $0$, $\pi$}, % Etichette matematiche pulite
        ytick={-1, 1},
...
\newcommand{\jimg}{\ensuremath{\mathop{} \! \mathrm{j}}}
...
% custom command for complex natural logarithm
\newcommand{\Ln}{\ensuremath{\mathop{} \! \mathrm{Ln}}}

% custom command for cjs
\newcommand{\cjs}{\ensuremath{\mathop{} \! \mathrm{cjs}}}

% custom command for signum function in desired notation
\newcommand{\sgn}{\ensuremath{\mathop{} \! \mathrm{sgn}}}

% custom command for fourier notation
\newcommand{\FR}{\ensuremath{\mathop{} \! \mathrm{FR}}}

% custom command for circeled numbers
