...
\begin{itemize}
    \item \textbf{Se $f(t)$ è PARI rispetto a $t_0$}:
    \begin{itemize}
        \item $a_n = 0 \iff \cos(n\omega_f \cdot \cor{t_0}) = 0$
        \item $b_n = 0 \iff \sin(n\omega_f \cdot \cor{t_0}) = 0$
    \end{itemize}
    \item \textbf{Se $f(t)$ è DISPARI rispetto a $t_0$}:
    \begin{itemize}
        \item $a_n = 0 \iff \cos(n\omega_f \cdot \cor{t_0}) = \pm 1$ (picco $\rightarrow$ pari rispetto a $\cor{t_0}$)
        \item $b_n = 0 \iff \sin(n\omega_f \cdot \cor{t_0}) = \pm 1$ (picco $\rightarrow$ pari rispetto a $\cor{t_0}$)
    \end{itemize}
\end{itemize}
