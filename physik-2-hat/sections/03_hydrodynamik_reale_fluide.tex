...
Beschreibung von \myul{\color{red}laminaren} Strömungen in einem \myul{runden Rohr} \textrightarrow\ Schichtströmung
...
Als Beurteilungskriterium von Strömung dient die Reynolds-Zahl. Ab einem kritischen Wert geht die laminare in eine instabile, turbulente Strömung über. Bei der
\cbl{laminaren} Strömung bewegt sich das Fluid in \cbl{geordneten, parallelen Schichten}. Bei der
\cvt{turbulenten Strömung} gibt es \cvt{intensive Verwirbelungen}.
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item $\Rey$ va \textbf{ricalcolato} per il regime turbolento
    \end{itemize}
...
La $v$ del termine $\Delta p_v$ e $\frac{1}{2}\alpha_n \cdot \dots$ sono \textbf{uguali}
