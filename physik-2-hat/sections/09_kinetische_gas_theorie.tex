...
\begin{center}
	\textbf{\color{red}Attenzione:} massa molare nei gas biatomici è spesso $M\cdot 2 \Longrightarrow O_2, H_2, N_2$
...
\begin{minipage}{0.48\columnwidth}
	$$ \boxed{\overline{l} =  \overline{\lambda} = 
	\frac{1}{\sqrt{2}} \cdot \frac{1}{n \cdot \pi \cdot d^2} }$$
...
\begin{minipage}{0.5\columnwidth}
	\begin{center}
		\includegraphics[width=0.7\linewidth]{images/mittlere_frei_weg.png}
...
\begin{minipage}[c]{0.48\columnwidth}
	...
	$$ \boxed{ \tau = - \eta \cdot \frac{\mathrm{dv}}{\mathrm{dx}} \qquad \quad  
	\eta = \frac{1}{3} \cdot \overline{v} \cdot \overline{\lambda} \cdot \rho }  $$
\end{minipage}
...
\begin{tabular}{c l c}
	$j_Q$ 					& Wärmestromdichte 															& $[j_Q] = \frac{\watt}{\meter^2}$ 			\\
	$\lambda_Q$ 			    & Wärmeleitfähigkeit 														& $[\lambda_Q] = \frac{\watt}{\meter \cdot \kelvin}$	\\
	$j_D$ 					& Diffusionsstrom 															& $[j_D] = \frac{1}{\second \cdot \meter^2}$ 								\\
	$D$ 					& Diffusionskonstante 														& $[D] = \frac{\meter^2}{\second}$ 			\\
	$\tau$ 					& Schubspannung 															& $[\tau] = \pascal$ 						\\
	$\eta$ 					& Viskosität	 															& $[\eta] = \pascal \, \second$ 			\\
	$n$ 					& Molekül-Dichte 															& $[n] = \frac{1}{\meter^3}$				\\	
