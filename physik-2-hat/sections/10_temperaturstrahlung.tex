...
$$ \boxed{\text{n Schichten:} \quad \frac{1}{k_{\rm tot}} = \frac{1}{\alpha_i} + \left(\sum_x  \frac{1}{k_x}\right) + \frac{1}{\alpha_a} } \quad \left(\frac{1}{k} = \frac{d}{\lambda}\right) $$
...
\begin{tabular}{@{} p{0.33\columnwidth} p{0.33\columnwidth} p{0.33\columnwidth} @{}}
    ...
    $\displaystyle \boxed{ W_{\rm ab} = n \cdot R \cdot T \cdot \ln \left(\frac{V_2}{V_1}\right) }$ & 
...
\textit{\textbf{Convenzione: }Se $W_{ab}$ è maggiore di 0 l'energia è fornita dal sistema all'ambiente}
