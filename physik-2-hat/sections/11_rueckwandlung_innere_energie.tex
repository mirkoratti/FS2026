...
\begin{tabular}{c l c}
	...
	$T_{\rm hoch}$ 	& Temperatur des Warm-Reservoirs \cvt{(Radiatore)}	& $[T_{\rm tief}] = \kelvin$	\\
	$T_{\rm tief}$ 	& Temperatur des Kalt-Reservoirs \cvt{(Terreno)}	& $[T_{\rm hoch}] = \kelvin$ 	\\
...
\begin{tabular}{c l c}
	...
	$T$			& Temperatur \textbf{\color{red}in kelvin} & $[T] = \kelvin$
\end{tabular}
